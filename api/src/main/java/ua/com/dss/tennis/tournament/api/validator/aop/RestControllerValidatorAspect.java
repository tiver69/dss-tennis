package ua.com.dss.tennis.tournament.api.validator.aop;
...
import static ua.com.dss.tennis.tournament.api.exception.ErrorConstants.ErrorKey.RESOURCE_OBJECT_ID_NOT_CORRESPOND_TO_REQUEST;
import static ua.com.dss.tennis.tournament.api.exception.ErrorConstants.ErrorKey.TEAM_PLAYER_REDUNDANT;
...
public class RestControllerValidatorAspect {
    ...
    @Pointcut("within(ua.com.dss.tennis.tournament.api.controller..*)")
